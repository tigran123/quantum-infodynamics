...
python3 solve.py -r -d "Quantum Relativistic Oscillator" $PARAMS -tol 0.007 -s $SOLQR &
python3 solve.py -r -c -d "Classical Relativistic Oscillator" $PARAMS -tol 0.0005 -s $SOLCR &
